  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ubah Data Kas Keluar</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <form action="proses/proses_edit_datakaskeluar.php" method="POST">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input name="ket" type="text" class="form-control" id="recipient-name" value="<?php echo $data['supplier'];?>">
          </div>
          <div class="mb-3">
...
<!-- Akhir Modal ubah data kas keluar -->

<!-- Modal hapus data kas keluar -->
<div class="modal fade" id="Modalhapus<?php echo $no ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Hapus Data Kas Keluar</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        Apakah anda yakin ingin menghapus data kas keluar ini?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
        <a href="proses/proses_hapus_datakaskeluar.php?id=<?php echo $data ['nama_barang'] ?>"
        class="btn btn-danger">Hapus</a>
      </div>
    </div>
  </div>
</div>
<!-- Akhir Modal hapus data kas keluar-->
...
<div class="modal fade" id="tambahdatabarang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="proses/proses_tambah_datakaskeluar.php" method="POST">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Supplier:</label>
            <input name="supplier" type="text" class="form-control" id="recipient-name">
          </div>
          <div class="mb-3">
            <label for="recipient-name" class="col-form-label">Tanggal:</label>
